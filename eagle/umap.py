...
def plot_umaps_for_models(models, output_dir="figures"):
    ...
    for idx, (model, embedding, labels) in enumerate(
        zip(models, model_embeddings, model_labels)
    ):
        ax = axes[idx]
    ...
    legend_elements = [
        Line2D(
            ...
            marker="o",
            color="w",
            markerfacecolor=cohort_colors["stad"],
            markersize=14,
            label="Stomach",
        ),
        Line2D(
            ...
            marker="o",
            color="w",
            markerfacecolor=cohort_colors["crc"],
            markersize=14,
            label="Bowel",
        ),
        Line2D(
            ...
            marker="o",
            color="w",
            markerfacecolor=cohort_colors["lung"],
            markersize=14,
            label="Lung",
        ),
        Line2D(
            ...
            marker="o",
            color="w",
            markerfacecolor=cohort_colors["brca"],
            markersize=14,
            label="Breast",
        ),
    ]
